...
# foo_hat = cp.fit_quadrature(orth_poly, zeta_quad, zeta_weight, np.squeeze(y_quad_mean))
# _zeta = dist_zeta.inv(dist_x.cdf(x))
# f_hat_mean = foo_hat(_zeta.T).reshape((_zeta.size,))
...
# plt.plot(x, f_hat_mean, color='y',label=r'Surrogate model Q')
