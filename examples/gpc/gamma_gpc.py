...
axes[1,1].plot(npoly_order, x1_stats_hat[:,4],linestyle=pltlinestyles[2],color=pltcolors[0], marker=pltmarkers[2], label=r'$\alpha={}$ (Hermite-chaos)')
axes[1,1].plot(npoly_order, x2_stats_hat[:,4],linestyle=pltlinestyles[2],color=pltcolors[1], marker=pltmarkers[2], label=r'$\alpha={}$ (Laguerre-chaos)')
...
plt.tight_layout()
plt.savefig('Figures/Gamma_pce.eps')
plt.savefig('Figures/Gamma_pce.png')
