...
def main():
    ...
    while i_iteration < iter_max:
        ...
        u_train_new, _ = modeling.get_train_data(n, u_cand_p, u_train, basis=pce_model.basis, active_basis=active_basis[p])
        ...
        print('   - New samples ({:s} {}): p={:d}, s={:d}, n={:d}, pct={:.2f} '.format(
            simparams.doe_method, simparams.optimality, p,sparsity[p], n, new_samples_pct[p]))
        ### ============ updating parameters ============
        p           += 1
        i_iteration += 1
