...
def main():
    ...
    error_params=None ## name, params, size = params
    ...
    doe_method, doe_rule, doe_orders = 'QUAD', 'hem', [2,3,4,5]
    ...
    # for iquad_order in metamodel_basis_setting:
        ...
        # data_set    = np.load(os.path.join(simparams.data_dir, 'DoE_QuadHem{:d}_y.npy'.format(iquad_order)))
        ...
        # np.save(os.path.join(simparams.data_dir, 'DoE_QuadHem{}_{}_score.npy'.format(iquad_order, metamodel_class)),y_valid_scores)
        # np.save(os.path.join(simparams.data_dir, 'DoE_QuadHem{}_{}_valid.npy'.format(iquad_order, metamodel_class)),y_valid)
        # np.save(os.path.join(simparams.data_dir, 'DoE_QuadHem{}_{}_grid.npy'.format(iquad_order, metamodel_class)),res_grid)
