...
"""
from uqra.experiment._experimentbase import ExperimentBaseExperimentalDesign
from uqra.utilities.decorators import random_state
from uqra.utilities.helpers import num2print
import numpy as np
import scipy
import itertools

class Coherence(ExperimentalDesign):
    """ Experimental Design with random sampling methods"""

    def __init__(self, distributions, random_seed=None):
        """
